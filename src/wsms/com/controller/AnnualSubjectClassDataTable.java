...
public class AnnualSubjectClassDataTable {
	@FXML private SimpleStringProperty sNo_Data;
	@FXML private SimpleStringProperty studentID_Data, name_Data, subject_Data, first_Data, second_Data, 
		third_Data, totalScores_Data, avg_Data, percentage_Data, position_Data;
	
	public AnnualSubjectClassDataTable(String sNo, String studentID, String name, String subject, 
			String first, String second, String third, String totalScores, String avg,
			String percentage, String position) {
	...
	public void setPpercentage_Data(String percentage) {
