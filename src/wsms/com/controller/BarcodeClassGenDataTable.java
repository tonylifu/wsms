...
public class BarcodeClassGenDataTable {
	@FXML private SimpleStringProperty sNo_Data;
	@FXML private SimpleStringProperty stdId_Data, name_Data, sex_Data, age_Data, border_Data, barcodeStatus_Data;
	
	public BarcodeClassGenDataTable(String sNo, String stdId, String name, String sex, String age, 
			String border, String barcodeStatus) {
