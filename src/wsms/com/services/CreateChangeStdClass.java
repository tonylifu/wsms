...
public class CreateChangeStdClass {
	public void createChangeStdClass(String stdClassId, String stdId, String name, String currentBorderStatus, String currentStdClass, 
		...
		ChangeStdClass std = new ChangeStdClass();
		
		std.setStdClassId(stdClassId);
		std.setStdId(stdId);
