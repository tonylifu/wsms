...
public class CreateCashTransactions {
	
	//Post a Transaction
	public void postCashTransactions(String TID, String stdNo, String accountName, String depWithdrawal,
		...
		CashTransactions transact2 = new CashTransactions();
