...
public class CreateChangeBorderStatus {
	public void createChangeBorderStatus(String changeBorderId, String stdId, String name, String stdClass, String currentBorderStatus,
		...
		ChangeBorderStatus border = new ChangeBorderStatus();
		
		border.setChangeBorderId(changeBorderId);
